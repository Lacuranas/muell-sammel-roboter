...
Diese drei Zeilen hinzufügen, um pyenv beim starten vom Terminal zu implementieren
...
Python 3.9.2 beben der System Python Version installieren, da der Script nur mit dieser Version stabil läuft. (TF-Lite benötige genau diese Version um richtig zu laufen)
    pyenv install 3.9.2

Lokale Python Version auf 3.9.2 stellen
    pyenv local 3.9.2
